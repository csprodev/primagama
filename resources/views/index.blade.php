        ...
        <div class="container">
            <div class="header-main">
                <?php include('header/logo.blade.php'); ?>
                 <div class="top-nav">
                     <span class="menu"> <img src={{ asset("assets/images/icon.png")}} alt=""></span>  
            ...
            <div class="events-grid">
                ...
                <div class="col-md-4 event-img">
                    <div class="item item-type-move">
                        ...
                        <div class="item-img">
                                <img src={{ asset("assets/images/e1.jpg")}} class="img-responsive" alt="">
                        </div>
                </div>
            ...
            <div class="events-grid">
                ...
                <div class="col-md-4 event-img">
                    <div class="item item-type-move">
                        ...
                        <div class="item-img">
                                <img src={{ asset("assets/images/e2.jpg")}} class="img-responsive" alt="">
                        </div>
                </div>
                </div>
               <div class="clearfix"> </div>
            ...
            <div class="events-grid">
                ...
                <div class="col-md-4 event-img">
                    <div class="item item-type-move">
                        ...
                        <div class="item-img">
                                <img src={{ asset("assets/images/e3.jpg")}} class="img-responsive" alt="">
                        </div>
                </div>
                </div>
               <div class="clearfix"> </div>
        ...
        <ul class="rslides" id="slider2">
          <li>
            <div class="clients-text">   
                <img src={{ asset("assets/images/c1.png")}} alt="">                
