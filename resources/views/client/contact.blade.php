...
<html>
<head>
<title>Learning a Education Category Flat Bootstrap Responsive  Website Template | Contact :: w3layouts</title>
	...
	<div class="container">
		<div class="contact-main">	
			...
			<div class="contact-block1">
			 	...
			 	<ul>
			    	<li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"> </span><p>Professor at Hampden-Sydney</p></li>
			    	<li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span><p>+1284 485 978</p></li>			    	
			    	<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><p><a href="mailto:info@example.com">Lorem@example.com</a></p></li>
			    </ul>
			 	</div>
